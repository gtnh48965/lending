        ...
        <div className="Third_screen">
            ...
            <div className="row  justify-content-md-center">
                ...
                <h2 className="one">
                    ...
                    <p className="tho">
                        на котором игроки смогут комфортно выстраивать свои взаимоотношения, создавать союзы и полноценно воевать. В общем - цивилизованно сосуществовать и получать от этого дело удовольствие
                ...
                <div className="but row">
                    ...
                    <div className="col-lg">
                        <h3>
                            Сейчас над проектом работает 5 человек
