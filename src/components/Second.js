    ...
    return (
        ...
        <div className="col-xl-6 text">
            ...
            <p>
                ...
                <br/>
                <br/>
                Задача нашего проекта - создать на базе этой модификации и существующих решений работоспособный игровой клиент, который позволит игрокам полноценно вступать в pvp сражения
                <br/>
                <br/>
